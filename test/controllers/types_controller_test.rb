...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference("Type.count") do
      post types_url, params: { type: { descripcion: @type.descripcion, nombre: @type.nombre } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { descripcion: @type.descripcion, nombre: @type.nombre } }
